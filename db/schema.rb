...
ActiveRecord::Schema.define(version: 20160806092149) do
  ...
  add_index "subscriptions", ["user_id", "subscriptable_id", "subscriptable_type"], name: "subscriptable_index", unique: true, using: :btree
